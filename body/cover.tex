...
\xuehao{D201780294} \schoolcode{10487}
\csubjectname{材料加工工程} \cauthorname{郭树人}
\csupervisorname{董选普} \csupervisortitle{教授}
\defencedate{\today} \grantdate{}
\chair{}%
...
\esubject{Materials Processing and Engineering}
\eauthor{GUO SHUREN}
\esupervisor{Prof. DONG XUANPU}
\edate{May, 2022}
